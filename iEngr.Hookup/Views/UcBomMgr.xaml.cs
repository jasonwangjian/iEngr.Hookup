...
namespace iEngr.Hookup.Views
{
    ...
    //                    BomListItem bomItem = new BomListItem() { ObjMat = item };
    ...
    //        BomListItem newBomItem = new BomListItem() { ObjMat = newMat };
    ...
    //        }
    //    }
    //    private void updateComosData(IComosBaseObject objComos, MatListItem objMatInLib)
    //    {
